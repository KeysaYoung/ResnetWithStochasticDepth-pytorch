...
def main():
    ...
    blocks = args.blocks
    deathRateList = torch.linspace(0, args.pL, steps=3*blocks)
    model = getattr(models, args.arch)([blocks, blocks, blocks], deathRateList,args.num_classes)
    ...
    for epoch in range(total_epoch):
        ...
        train_loss, train_prec1, train_prec5 = train(train_loader, model, criterion, optimizer, epoch)
