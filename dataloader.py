...
def get_dataloaders(args):
    ...
    if args.data == 'cifar10':
        ...
        val_set = datasets.CIFAR10(args.data_root, train=True,
                                   transform=transforms.Compose([
                                    transforms.ToTensor(),
                                    normalize
                                   ]))
        ...
        val_set = datasets.CIFAR100(args.data_root, train=True,
                                    transform=transforms.Compose([
                                        transforms.ToTensor(),
                                        normalize
                                    ]))
        ...
        val_set = datasets.ImageFolder(traindir, transforms.Compose([
